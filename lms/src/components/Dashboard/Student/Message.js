                            ...
                            <div className="dashboard__inner sticky-top">
                                ...
                                <div className="dashboard__nav">
                                    <ul>
                                        ...
                                        <li>
                                            <Link className="active" to="../Student/Message.js">
                                            ...
                                            <div className="dashboard__meessage__content__wrap">
                                                <div className="dashboard__meessage__profile">
                                                    ...
                                                    <div className="dashboard__meessage__profile__chat__option">
                                                        <Link to="admin-dashboard.html"><i className="icofont-phone"></i></Link>
                                                        <Link to="admin-dashboard.html"><i className="icofont-ui-video-chat"></i></Link>
                                                    </div>
                                                </div>
                                                ...
                                                <i className="icofont-attachment attachment" aria-hidden="true"></i>
                                                    <button className="submit"><i className="icofont-arrow-right"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
