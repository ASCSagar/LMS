                            ...
                            <div className="dashboard__inner sticky-top">
                                ...
                                <div className="dashboard__nav">
                                    <ul>
                                        ...
                                        <li>
                                            <Link className="active" to="../Student/Settings.js">
                        ...
                        <div className="dashboard__content__wraper">
                            ...
                            <div className="row">
                                <div className="col-xl-12 aos-init aos-animate" data-aos="fade-up">
                                    <ul className="nav  about__button__wrap dashboard__button__wrap" id="myTab"
                                        role="tablist">
                                        <li className="nav-item" role="presentation">
                                            <button className="single__tab__link active" data-bs-toggle="tab"
                                                data-bs-target="#projects__one" type="button" aria-selected="true"
                                                role="tab">Profile</button>
                                        </li>
                                        <li className="nav-item" role="presentation">
                                            <button className="single__tab__link" data-bs-toggle="tab"
                                ...
                                <div className="tab-content tab__content__wrapper aos-init aos-animate" id="myTabContent"
                                    data-aos="fade-up">
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-xl-12">
                                                    <div className="dashboard__form__button">
                                                        <Link className="default__button" to="#">Update Info</Link>
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
                                ...
                                <div className="tab-pane fade" id="projects__two" role="tabpanel"
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-xl-12">
                                            <div className="dashboard__form__button">
                                                <Link className="default__button" to="#">Update Password</Link>
                                            </div>
                                        </div>
                                ...
                                <div className="tab-pane fade" id="projects__three" role="tabpanel"
