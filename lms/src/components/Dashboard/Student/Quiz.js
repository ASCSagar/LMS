                            ...
                            <div className="dashboard__inner sticky-top">
                                ...
                                <div className="dashboard__nav">
                                    <ul>
                                        ...
                                        <li>
                                            <Link className="active" to="../Student/Quiz.js">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <th>
                                                        ...
                                                        <p>Student: <Link to="#">Mice Jerry</Link></p>
                                                    </th>
                                                    <td>
                                                        <p>4</p>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <span className="dashboard__td dashboard__td--cancel">Cancel</span>
                                                    </td>
                                                    <td>
                                                        <div className="dashboard__button__group">
                                                        <Link className="dashboard__small__btn__2" to="#"> <i className="icofont-eye"></i>View</Link>
                                                ...
                                                <tr className="dashboard__table__row">
                                                    ...
                                                    <td>
                                                        <span className="dashboard__td dashboard__td--over">Over</span>
                                                    </td>
                                                    <td>
                                                        <div className="dashboard__button__group">
                                                            <Link className="dashboard__small__btn__2" to="#"> <i className="icofont-eye"></i>View</Link>
