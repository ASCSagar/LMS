    ...
    <>
        ...
        <div class="herobannerarea herobannerarea__2">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                        <div class="herobannerarea__content__wraper">
                            ...
                            <div class="hreobannerarea__button__2">
                                <Link class="default__button" to="#">View Courses</Link>
                                <Link class="default__button hreobannerarea__button__3" to="#">Explore More</Link>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
            ...
            <div class="herobannerarea__icon__2">
                <img class="herobanner__common__img herobanner__img__1" src={herobanner__1} alt="photoo"/>
                <img class="herobanner__common__img herobanner__img__2" src={herobanner__2} alt="photoo"/>
                <img class="herobanner__common__img herobanner__img__3" src={herobanner__3} alt="photoo"/>
                <img class="herobanner__common__img herobanner__img__4" src={herobanner__4} alt="photoo"/>
                <img class="herobanner__common__img herobanner__img__5" src={herobanner__5} alt="photoo"/>
            </div>
        </div>
