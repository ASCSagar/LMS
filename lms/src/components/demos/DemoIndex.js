  ...
  return (
    <>
      <li className="mega__menu position-static">
        <Link className="headerarea__has__dropdown" to="index.html">
          Demos<i className="icofont-rounded-down"></i>
        </Link>
        <div className="headerarea__submenu mega__menu__wrapper mega__menu__grid__5">
          <ul className="nav  tab__button__wrap" id="myTab2" role="tablist">
          ...
          <div className="tab-content tab__content__wrapper" id="myTabContent2">
            <div
              ...
              <div className="row">
                ...
                <div className="col-3 mega__menu__single__wrap">
                  <div className="mega__menu__thumb">
                    ...
                    <span className="mega__menu__thumb__label">New</span>
                  </div>
                </div>
                <div className="col-3 mega__menu__single__wrap">
                  <div className="mega__menu__thumb">
