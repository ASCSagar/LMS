          ...
          <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
            <div className="about__right__wraper__2">
              <div className="educationarea__img" data-tilt>
                <img className="aboutarea__2__img__1" src={about2} alt="education" />
                <img className="aboutarea__2__img__2" src={about3} alt="education" />
                <img className="aboutarea__2__img__3" src={about4} alt="education" />
                <img className="aboutarea__2__img__4" src={about11} alt="education" />
              </div>
          ...
          <div className="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
            <div className="aboutarea__content__wraper">
              ...
              <div className="aboutarea__list__2">
                <ul>
                  <li>
                    <i className="icofont-check"></i> Lorem Ipsum is simply dummy
                  </li>
                  <li>
                    <i className="icofont-check"></i> Explore a variety of fresh educational teach
                  </li>
                  <li>
                    <i className="icofont-check"></i> Lorem Ipsum is simply dummy text of
                  </li>
                </ul>
              </div>
            </div>
