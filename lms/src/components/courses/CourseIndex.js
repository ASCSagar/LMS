          ...
          <div class="row">
            <div class="col-3 mega__menu__single__wrap">
              ...
              <ul class="mega__menu__item">
                ...
                <li>
                  <Link to="course-dark.html">Course Grid (Dark)</Link>
                </li>
                <li>
                  <Link to="course-grid.html">Course Grid</Link>
                </li>
                <li>
                  <Link to="course-grid-dark.html">Course Grid (Dark)</Link>
                </li>
                <li>
                  <Link to="course-list.html">Course List</Link>
                </li>
                <li>
                  <Link to="course-list-dark.html">Course List (Dark)</Link>
                </li>
              </ul>
            </div>
            <div class="col-3 mega__menu__single__wrap">
              ...
              <ul class="mega__menu__item">
                ...
                <li>
                  <Link to="course-details-2.html">Course Details 2</Link>
                </li>
                <li>
                  <Link to="course-details-2-dark.html">Details 2 (Dark)</Link>
                </li>
                <li>
                  <Link to="course-details-3.html">Course Details 3</Link>
                </li>
                <li>
                  <Link to="course-details-3.html">Details 3 (Dark)</Link>
                </li>
              </ul>
            </div>
            <div class="col-3 mega__menu__single__wrap">
              ...
              <ul class="mega__menu__item">
                ...
                <li>
                  <Link to="instructor-dark.html">Instructor (Dark)</Link>
                </li>
                <li>
                  <Link to="instructor-details.html">Instructor Details</Link>
                </li>
                <li>
                  <Link to="lesson.html">
                    Course Lesson
